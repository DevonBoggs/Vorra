...
export const LIFE_TEMPLATES = {
  ...
  'parent': {
    ...
    weeklyAvailability: {
      0: { available: true,  windows: [{ start: '11:30', end: '14:30' }, { start: '20:30', end: '23:00' }] },
      ...
      6: { available: true,  windows: [{ start: '11:30', end: '14:30' }, { start: '20:30', end: '23:00' }] },
    },
    commitments: [
      ...
      { id: 'kids-we', label: 'Family time (morning)', days: [0, 6], start: '07:00', end: '11:30', category: 'family' },
      { id: 'kids-we-pm', label: 'Family time (afternoon)', days: [0, 6], start: '14:30', end: '18:00', category: 'family' },
  ...
  'remote-worker': {
    label: 'Remote Worker',
    icon: '\uD83D\uDCBB',
    description: 'Work, study break, work, evenings',
    weeklyAvailability: {
      0: { available: true,  windows: [{ start: '09:00', end: '13:00' }, { start: '15:00', end: '18:00' }] },
      1: { available: true,  windows: [{ start: '12:00', end: '13:00' }, { start: '17:30', end: '21:00' }] },
      2: { available: true,  windows: [{ start: '12:00', end: '13:00' }, { start: '17:30', end: '21:00' }] },
      3: { available: true,  windows: [{ start: '12:00', end: '13:00' }, { start: '17:30', end: '21:00' }] },
      4: { available: true,  windows: [{ start: '12:00', end: '13:00' }, { start: '17:30', end: '21:00' }] },
      5: { available: true,  windows: [{ start: '12:00', end: '13:00' }, { start: '17:30', end: '21:00' }] },
      6: { available: true,  windows: [{ start: '09:00', end: '13:00' }, { start: '15:00', end: '18:00' }] },
    },
    commitments: [
      { id: 'work-am', label: 'Morning work', days: [1, 2, 3, 4, 5], start: '09:00', end: '12:00', category: 'work' },
      { id: 'work-pm', label: 'Afternoon work', days: [1, 2, 3, 4, 5], start: '13:00', end: '17:00', category: 'work' },
      { id: 'wind-down', label: 'Wind down', days: [1, 2, 3, 4, 5], start: '17:00', end: '17:30', category: 'other' },
    ],
  },
  'retiree': {
