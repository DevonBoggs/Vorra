...
export const LIFE_TEMPLATES = {
  'nine-to-five': {
    ...
    weeklyAvailability: {
      ...
      1: { available: true,  windows: [{ start: '19:30', end: '22:30' }] },
      2: { available: true,  windows: [{ start: '19:30', end: '22:30' }] },
      3: { available: true,  windows: [{ start: '19:30', end: '22:30' }] },
      4: { available: true,  windows: [{ start: '19:30', end: '22:30' }] },
      5: { available: true,  windows: [{ start: '19:30', end: '22:30' }] },
  ...
  'night-shift': {
    ...
    weeklyAvailability: {
      0: { available: true,  windows: [{ start: '10:00', end: '14:00' }, { start: '16:00', end: '19:00' }] },
      1: { available: true,  windows: [{ start: '15:00', end: '19:00' }] },
      2: { available: true,  windows: [{ start: '15:00', end: '19:00' }] },
      3: { available: true,  windows: [{ start: '15:00', end: '19:00' }] },
      4: { available: true,  windows: [{ start: '15:00', end: '19:00' }] },
      5: { available: true,  windows: [{ start: '15:00', end: '19:00' }] },
      6: { available: true,  windows: [{ start: '10:00', end: '14:00' }, { start: '16:00', end: '19:00' }] },
    },
    commitments: [
  ...
  'parent': {
    ...
    commitments: [
      ...
      { id: 'kids-we', label: 'Kids (weekend)', days: [0, 6], start: '08:00', end: '12:00', category: 'family' },
    ],
  },
  'full-time-student': {
    label: 'Full-Time Student',
    icon: '\uD83C\uDF93',
    description: 'Structured days with breaks',
    weeklyAvailability: {
      0: { available: false, windows: [] },
      1: { available: true,  windows: [{ start: '09:00', end: '12:30' }, { start: '14:00', end: '18:00' }] },
      2: { available: true,  windows: [{ start: '09:00', end: '12:30' }, { start: '14:00', end: '18:00' }] },
      3: { available: true,  windows: [{ start: '09:00', end: '12:30' }, { start: '14:00', end: '18:00' }] },
      4: { available: true,  windows: [{ start: '09:00', end: '12:30' }, { start: '14:00', end: '18:00' }] },
      5: { available: true,  windows: [{ start: '09:00', end: '12:30' }, { start: '14:00', end: '18:00' }] },
  ...
  'healthcare': {
    ...
    icon: '\u2695\uFE0F',
    description: '3 on / 4 off rotation',
    weeklyAvailability: {
      0: { available: false, windows: [] },
      1: { available: false, windows: [] },
      2: { available: false, windows: [] },
      3: { available: false, windows: [] },
      4: { available: true,  windows: [{ start: '09:00', end: '13:00' }, { start: '15:00', end: '18:00' }] },
  ...
  'remote-worker': {
    ...
    weeklyAvailability: {
      ...
      1: { available: true,  windows: [{ start: '07:30', end: '08:45' }, { start: '12:00', end: '13:00' }, { start: '18:00', end: '21:00' }] },
      2: { available: true,  windows: [{ start: '07:30', end: '08:45' }, { start: '12:00', end: '13:00' }, { start: '18:00', end: '21:00' }] },
      3: { available: true,  windows: [{ start: '07:30', end: '08:45' }, { start: '12:00', end: '13:00' }, { start: '18:00', end: '21:00' }] },
      4: { available: true,  windows: [{ start: '07:30', end: '08:45' }, { start: '12:00', end: '13:00' }, { start: '18:00', end: '21:00' }] },
      5: { available: true,  windows: [{ start: '07:30', end: '08:45' }, { start: '12:00', end: '13:00' }, { start: '18:00', end: '21:00' }] },
  ...
  'retail': {
    ...
    icon: '\uD83D\uDED2',
    description: 'Mornings free, shift afternoons',
    weeklyAvailability: {
      0: { available: true,  windows: [{ start: '08:00', end: '12:00' }] },
      1: { available: true,  windows: [{ start: '08:00', end: '12:00' }] },
      2: { available: true,  windows: [{ start: '08:00', end: '12:00' }] },
      3: { available: true,  windows: [{ start: '08:00', end: '12:00' }] },
    ...
    commitments: [
      { id: 'shift', label: 'Shift work', days: [1, 2, 3, 4], start: '15:00', end: '22:00', category: 'work' },
      { id: 'weekend-shift', label: 'Weekend shift', days: [0, 5, 6], start: '13:00', end: '21:00', category: 'work' },
    ],
  },
  'blank-slate': {
    label: 'Blank Slate',
